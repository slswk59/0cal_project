      ...
      <section class="recommend-items">
        ...
        <div class="recommend-slide">
          <ul class="recommend-slide-items">
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item2.jpg" alt="추천 상품" />
              </div>
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item3.jpg" alt="추천 상품" />
              </div>
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item4.jpg" alt="추천 상품" />
              </div>
          ...
          <ul class="recommend-slide-items hidden">
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item5.jpg" alt="추천 상품" />
              </div>
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item6.jpg" alt="추천 상품" />
              </div>
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item7.jpg" alt="추천 상품" />
              </div>
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item8.jpg" alt="추천 상품" />
              </div>
          ...
          <ul class="recommend-slide-items hidden">
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item9.jpg" alt="추천 상품" />
              </div>
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item10.jpg" alt="추천 상품" />
              </div>
              <h3 class="item-name">
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item11.jpg" alt="추천 상품" />
              </div>
            ...
            <li class="recommend-slide-item">
              <div class="item-img-container">
                <img class="item-img" src="./resources/img/item12.jpg" alt="추천 상품" />
              </div>
        ...
        <div class="today-item">
          <div class="today-wrapper">
            <div class="today-img-container">
              <img class="today-img" src="./resources/img/today1.jpg" alt="오늘 특가" />
            </div>
