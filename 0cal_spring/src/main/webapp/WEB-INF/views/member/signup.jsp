...
//                 }),
        ...
        /* 	var param = ""; */
        	...
        	param = "id="             + $("#inputId").val()
        	      + "&nick_name="     + $("#inputNick").val()
        	      + "&user_pass="     + $("#pw").val()
        	      + "&user_name="     + $("#inputName").val()
        	      + "&email="         + $("#inputMail").val()
        	      + "&address="       + $("#postcode").val() + " " + $("#roadAddress").val() + " " + $("#jibunAddress").val() + " " + $("#detailAddress").val() + " " + $("#extraAddress").val() //통합주소
    ...
    <div class="wrapper">
        ...
        <div class="user">
            ...
            <div class="id">
                ...
                <button class="doubleCheck" id="dupCheckId" onclick="dupCheck('Id',inputId.value);">중복확인</button>
            </div>
            <div class="chk">
            ...
            <div class="nick">
                ...
                <input type="text" name="nick_name" id="inputNick" class="middle" maxlength="10" placeholder="닉네임을 입력해주세요." onkeyup="chkNick();"></input>
            ...
            <div class="phone">
                ...
                <input type="text" id="inputPhone" name="phone" class="middle" maxlength="13" placeholder="010&nbsp-&nbsp 0000 &nbsp-&nbsp 0000" onkeyup="chkPhone();"></input>
            </div>
            <div class="chk">
            ...
            <div class="adress2">
                <div class="front"></div>
                <input type="text" class="left" id="roadAddress" name="roadAddress" placeholder="도로명주소">
                <input type="text" class="right" id="jibunAddress" name="jibunAddress" placeholder="지번주소">
            </div>
            <div class="adress2">
                <div class="front"></div><span id="guide" style="color:#999;display:none"></span>
                <input type="text" class="left" id="detailAddress" name="detailAddress" placeholder="상세주소">
                <input type="text" class="right" id="extraAddress" name="extraAddress" placeholder="참고항목">
            </div>
            <div class="gender">
            ...
            <div class="birth">
                <div class="front" id="ymd">생년월일&nbsp<span class="star">*</span></div>               
                    <p><input type="date" id="inputYmd" name="date_of_birthday" class="middle"></p>
            </div>
