...
<!--     <head profile="http://www.w3.org/2005/10/profile"></head> -->
    ...
    function dupCheck(key, value){
    	...
    	if("Id" == key){
        	...
        	if(NICK_DUP_YN) return;
    	} else if("Mail" == key){
        	if(MAIL_DUP_YN) return;
    	}
    ...
    function updateMember(){
	    ...
	    var param = "id="             + $("#inputId").val()
	     		  + "&nick_name="     + $("#inputNick").val()
	    	      + "&user_pass="     + user_pass
            ...
            <div class="signup_edit_div">개인정보수정</div>
                ...
                <div class="user">
                  ...
                  <div class="nick">
                      ...
                      <input type="text" name="nick_name" id="inputNick" class="middle" maxlength="10" value="${memberDTO.nick_name}" placeholder="닉네임을 입력해주세요." onkeyup="chkNick();"></input>
                      <button class="doubleCheck" id="dupCheckNick" onclick="dupCheck('Nick',inputNick.value);">중복확인</button>
            	  </div>
                  <div class="chk">
                  ...
                  <div class="pw">
                      ...
                      <input type="password" name="user_pass" id="pw" class="middle" onkeyup="chkPw();" placeholder="현재 비밀번호를 입력해주세요."></input>
                  </div>
                  <div class="chk">
                  ...
                  <div class="newPw">
                      ...
                      <input type="password" name="newPassword" id="newPw" class="middle" onkeyup="chkNewPw();" placeholder="새 비밀번호를 입력해주세요."></input>
                  </div>
                  <div class="chk">
                      <div class="front"></div><span id="chkNewPw" style="font-size:x-small; padding-top:1px"></span>
                  </div>
                  
                  <div class="pwcheck">
                      <div class="front" id="userpwcheck">비밀번호 확인&nbsp<span class="star">*</span></div>
                      <input type="password" id="newPwChk" class="middle" onkeyup="isSame();" placeholder="새 비밀번호를 한번 더 입력해주세요."></input>
                  </div>
                  <div class="chk">
                  ...
                  <div class="email">
                      ...
                      <button class="doubleCheck" id="dupCheckMail" onclick="dupCheck('Mail',inputMail.value);">중복확인</button>
            	  </div>
                  <div class="chk">
                  ...
                  <div class="phone">
                      ...
                      <input type="text" id="inputPhone" name="phone" class="middle" value="${memberDTO.phone}" maxlength="13" placeholder="010&nbsp-&nbsp 0000 &nbsp-&nbsp 0000" onkeyup="chkPhone();"></input>
                  </div>
                  <div class="chk">
                  ...
                  <div class="adress2">
                      <div class="front"></div>
                      <input type="text" class="left" id="roadAddress" name="roadAddress" value="${memberDTO.roadAddress}" placeholder="도로명주소">
                      <input type="text" class="right" id="jibunAddress" name="jibunAddress" value="${memberDTO.jibunAddress}" placeholder="지번주소">
                  </div>
                  <div class="adress2">
                      <div class="front"></div><span id="guide" style="color:#999;display:none"></span>
                      <input type="text" class="left" id="detailAddress" name="detailAddress" value="${memberDTO.detailAddress}" placeholder="상세주소">
                      <input type="text" class="right" id="extraAddress" name="extraAddress" value="${memberDTO.extraAddress}" placeholder="참고항목">
                  </div>
                  <div class="gender">
                  ...
                  <div class="birth">
                      <div class="front" id="ymd">생년월일&nbsp<span class="star">*</span></div>
                          <p><input type="date" id="inputYmd" name="date_of_birthday" class="middle" value="${memberDTO.date_birthday}"></p>
                  </div>
      
                  <hr class="bottom">

                  <div class="btns">
                      <button type="submit" class="signupEdit" onclick="updateMember()"><span class="editText">회원정보수정</span></button>
                      <button type="button" value="전송2" class="editSuc" onclick="deleteMember()"><span class="editText">탈퇴하기</span></button>
                  </div>
              </div>
        </div>
    </div>
